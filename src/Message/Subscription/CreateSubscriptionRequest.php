...
class CreateSubscriptionRequest extends AbstractRequest
{
    ...
    public function sendData($data): Response
    {
        ...
        $paymentCard->setCardAlias($data['cardName']);
        ...
        $result = \Iyzipay\Model\Subscription\SubscriptionCreate::create($request, $options);
    ...
    public function setCardNumber(string $value): static
    {
    ...
    public function setCardHolderName(string $value): static
    {
    ...
    {
        return $this->getParameter('expireMonth');
    }

    public function setExpireMonth(string $value): static
    {
        return $this->setParameter('expireMonth', $value);
    }

    public function getExpireYear(): ?string
    {
        return $this->getParameter('expireYear');
    }

    public function setExpireYear(string $value): static
    {
        return $this->setParameter('expireYear', $value);
    }
    ...
    public function setCvc(string $value): static
    {
