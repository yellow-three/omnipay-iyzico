...
use Omnipay\Iyzico\Message\Marketplace\ApprovePaymentRequest;
...
{
    private ApprovePaymentRequest $request;

    protected function setUp(): void
    {
        $httpClient = $this->createMock(ClientInterface::class);
        $httpRequest = $this->createMock(HttpRequest::class);
        $this->request = new ApprovePaymentRequest($httpClient, $httpRequest);
    }
    ...
    public function testSendDataWithFailedRequestReturnsFailedResponse(): void
    {
        ...
        $httpClient->expects($this->once())
            ...
            ->willReturn(json_encode([
                'status' => 'failure',
                'errorCode' => '5004',
                'errorMessage' => 'Payment transaction approval failed',
                'errorGroup' => 'APPROVAL_ERROR',
                'locale' => 'TR',
                'systemTime' => '1458545234852',
        ...
        $this->assertStringContainsString('Payment transaction approval failed', $response->getMessage());
    }
}
