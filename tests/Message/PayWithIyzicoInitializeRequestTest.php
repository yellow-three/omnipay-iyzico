...
use Omnipay\Iyzico\Message\PayWithIyzicoInitializeRequest;
...
class PayWithIyzicoInitializeRequestTest extends TestCase
{
    private PayWithIyzicoInitializeRequest $request;
    ...
    protected function setUp(): void
    {
        ...
        $this->request = new PayWithIyzicoInitializeRequest($httpClient, $httpRequest);
    }
    ...
    public function testSendDataWithFailedResponseReturnsFailedRedirectResponse(): void
    {
        ...
        $httpClient->expects($this->once())
            ...
            ->willReturn(json_encode([
                'status' => 'failure',
                'errorCode' => '5002',
                'errorMessage' => 'PayWithIyzico initialization failed',
        ...
        $this->assertStringContainsString('PayWithIyzico initialization failed', $response->getMessage());
    }
