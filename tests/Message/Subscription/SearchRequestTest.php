...
use Omnipay\Iyzico\Message\Subscription\SearchRequest;
...
class SearchRequestTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->request = new SearchRequest($httpClient, $httpRequest);
    }
    ...
    public function testGetDataReturnsCorrectArray(): void
    {
        ...
        $this->request->setParentReferenceCode('parent_ref_456');
        ...
        $this->assertSame('parent_ref_456', $data['parentReferenceCode']);
        $this->assertSame('cust_ref_789', $data['customerReferenceCode']);
    ...
    public function testGetParentReferenceCode(): void
    {
        ...
        $this->assertSame('parent_ref_789', $this->request->getParentReferenceCode());
    }

    public function testGetCustomerReferenceCode(): void
    {
        $this->request->setCustomerReferenceCode('cust_ref_000');

        $this->assertSame('cust_ref_000', $this->request->getCustomerReferenceCode());
    }
    ...
    public function testSendDataWithFailedRequestReturnsFailedResponse(): void
    {
        ...
        $httpClient->expects($this->once())
            ...
            ->willReturn(json_encode([
                'status' => 'failure',
                'errorCode' => '5009',
                'errorMessage' => 'Subscription search failed',
                'errorGroup' => 'SEARCH_ERROR',
                'locale' => 'TR',
                'systemTime' => '1458545234852',
        ...
        $this->assertSame('5009', $response->getCode());
        $this->assertStringContainsString('Subscription search failed', $response->getMessage());
    }
}
