...
use Omnipay\Iyzico\Message\Subscription\CancelRequest;
...
class CancelRequestTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->request = new CancelRequest($httpClient, $httpRequest);
    }
    ...
    public function testSendDataWithFailedRequestReturnsFailedResponse(): void
    {
        ...
        $this->assertStringContainsString('Subscription cancellation failed', $response->getMessage());
    }
}
