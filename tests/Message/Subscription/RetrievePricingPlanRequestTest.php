...
use Omnipay\Iyzico\Message\Subscription\RetrievePricingPlanRequest;
use PHPUnit\Framework\TestCase;
use Symfony\Component\HttpFoundation\Request as HttpRequest;

class RetrievePricingPlanRequestTest extends TestCase
{
    private RetrievePricingPlanRequest $request;

    protected function setUp(): void
    {
        $httpClient = $this->createMock(ClientInterface::class);
        $httpRequest = $this->createMock(HttpRequest::class);
        $this->request = new RetrievePricingPlanRequest($httpClient, $httpRequest);
    }
