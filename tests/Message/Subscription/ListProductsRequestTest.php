...
use Omnipay\Iyzico\Message\Subscription\ListProductsRequest;
...
class ListProductsRequestTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->request = new ListProductsRequest($httpClient, $httpRequest);
    }
    ...
    public function testGetDataReturnsDefaultValuesWhenNotSet(): void
    {
        $this->request->setLocale('TR');
    ...
    public function testSetCountReturnsSelf(): void
    {
    ...
    public function testSendDataWithFailedRequestReturnsFailedResponse(): void
    {
        ...
        $httpClient->expects($this->once())
            ...
            ->willReturn(json_encode([
                'status' => 'failure',
                'errorCode' => '5005',
                'errorMessage' => 'List products failed',
        ...
        $this->assertStringContainsString('List products failed', $response->getMessage());
    }
}
