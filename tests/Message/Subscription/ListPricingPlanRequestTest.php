...
use Omnipay\Iyzico\Message\Subscription\ListPricingPlanRequest;
use PHPUnit\Framework\TestCase;
use Symfony\Component\HttpFoundation\Request as HttpRequest;

class ListPricingPlanRequestTest extends TestCase
{
    private ListPricingPlanRequest $request;

    protected function setUp(): void
    {
        $httpClient = $this->createMock(ClientInterface::class);
        $httpRequest = $this->createMock(HttpRequest::class);
        $this->request = new ListPricingPlanRequest($httpClient, $httpRequest);
    }
