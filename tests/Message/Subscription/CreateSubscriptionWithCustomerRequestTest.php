...
use Omnipay\Iyzico\Message\Subscription\CreateSubscriptionWithCustomerRequest;
use Omnipay\Iyzico\Message\Response;
use PHPUnit\Framework\TestCase;
use Symfony\Component\HttpFoundation\Request as HttpRequest;

class CreateSubscriptionWithCustomerRequestTest extends TestCase
{
    private CreateSubscriptionWithCustomerRequest $request;

    protected function setUp(): void
    {
        $httpClient = $this->createMock(ClientInterface::class);
        $httpRequest = $this->createMock(HttpRequest::class);
        $this->request = new CreateSubscriptionWithCustomerRequest($httpClient, $httpRequest);
    }
    ...
    public function testSendDataWithFailedRequestReturnsFailedResponse(): void
    {
        ...
        $this->request->setCustomerReferenceCode('cust_ref_fail');
        $this->request->setSubscriptionInitialStatus('ACTIVE');
        $this->request->setLocale('TR');
