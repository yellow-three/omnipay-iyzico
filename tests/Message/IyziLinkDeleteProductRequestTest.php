...
use Omnipay\Iyzico\Message\IyziLinkDeleteProductRequest;
use Omnipay\Iyzico\Message\Response;
use PHPUnit\Framework\TestCase;
use Symfony\Component\HttpFoundation\Request as HttpRequest;

class IyziLinkDeleteProductRequestTest extends TestCase
{
    private IyziLinkDeleteProductRequest $request;
    ...
    protected function setUp(): void
    {
        ...
        $this->request = new IyziLinkDeleteProductRequest($httpClient, $httpRequest);
    }
    ...
    public function testGetDataReturnsCorrectArray(): void
    {
        ...
        $this->assertSame('token_abc', $data['token']);
    }

    public function testSetAndGetToken(): void
    {
        $result = $this->request->setToken('tok_123');
        $this->assertSame($this->request, $result);
        $this->assertSame('tok_123', $this->request->getToken());
    }

    public function testSendDataReturnsResponse(): void
    {
        $this->request->setToken('token_del');
